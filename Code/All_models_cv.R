...
#Use definition I of persistent hotspots? If yes, Used.PHS.I = TRUE, FALSE otherwise.
Used.PHS.I  <- TRUE
...
#@ 1. Tanzania
#@ 2. Kenya
#@ 3. Combined-countries
#@ 4. Between-countries: Between I
#@ 5. Between-countries: Between II
Scenarios    <- c(1:5)
...
Predictor.Around.Villages   <-  c( "sim_Prevalence_Y1"
                                  , "sim_Prevalence_gt200epg_Y1"
                                  , "sim_s_Mean_intensity_epg_Overall_Y1"
                                  , "cluster"
                                  )
# ---- Predictor.Geography ----
